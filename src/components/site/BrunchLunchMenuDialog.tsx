...
import menuPdf from "@/assets/Glasshouse_Brunch_Lunch_Menu_v5.pdf.asset.json";
import page1 from "@/assets/brunch-lunch-menu-v5-page-1.png.asset.json";
import page2 from "@/assets/brunch-lunch-menu-v5-page-2.png.asset.json";
