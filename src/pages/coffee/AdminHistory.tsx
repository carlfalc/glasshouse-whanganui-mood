...
function HistoryContent() {
  ...
  return (
    <>
      ...
      <h1 className="text-2xl font-semibold text-slate-900 mb-1">Coffee History</h1>
      <p className="text-sm text-slate-500 mb-6">Completed orders appear here automatically.</p>
